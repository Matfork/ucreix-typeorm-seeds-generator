...
var SeedRevertCommand = (function () {
    function SeedRevertCommand() {
        this.command = 'seed:revert';
        this.describe = 'Reverts last executed seed.';
    }
    SeedRevertCommand.prototype.builder = function (args) {
        return args
            .option('c', {
            alias: 'connection',
            default: 'default',
    ...
    SeedRevertCommand.prototype.handler = function (args) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        return [4, seedExecutor.runUndoLastSeed(options)];
                    case 5:
                        _a.sent();
    ...
    return SeedRevertCommand;
}());
exports.SeedRevertCommand = SeedRevertCommand;
//# sourceMappingURL=SeedRevertCommand.js.map