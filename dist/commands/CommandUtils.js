...
var CommandUtils = (function () {
    ...
    CommandUtils.createDirectories = function (directory) {
        return new Promise(function (ok, fail) {
            return mkdirp(directory, function (err) { return (err ? fail(err) : ok()); });
        });
    };
    CommandUtils.createFile = function (filePath, content, override) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, CommandUtils.createDirectories(path.dirname(filePath))];
                    case 1:
                        _a.sent();
                        return [2, new Promise(function (ok, fail) {
            ...
            return __generator(this, function (_a) {
                return [2, new Promise(function (ok, fail) {
                        fs.readFile(filePath, function (err, data) {
                            return err ? fail(err) : ok(data.toString());
                        });
                    })];
            });
        });
    ...
    CommandUtils.fileExists = function (filePath) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                return [2, fs.existsSync(filePath)];
            });
        });
    };
    return CommandUtils;
