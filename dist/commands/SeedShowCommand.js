...
var SeedShowCommand = (function () {
    function SeedShowCommand() {
        this.command = 'seed:show';
        this.describe = 'Show all seeds and whether they have been run or not';
    }
    SeedShowCommand.prototype.builder = function (args) {
        return args
            .option('connection', {
            alias: 'c',
            default: 'default',
    ...
    SeedShowCommand.prototype.handler = function (args) {
        return __awaiter(this, void 0, void 0, function () {
            var connection, connectionOptionsReader, connectionOptions, seedExecutor, unappliedSeeds, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        ...
                        return [4, seedExecutor.showSeeds()];
                    case 5:
                        unappliedSeeds = _a.sent();
    ...
    return SeedShowCommand;
}());
exports.SeedShowCommand = SeedShowCommand;
//# sourceMappingURL=SeedShowCommand.js.map