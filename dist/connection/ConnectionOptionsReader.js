...
var fs = require("fs");
var ConnectionOptionsReader = (function () {
    ...
    ConnectionOptionsReader.prototype.load = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                foundFileFormat = fileExtension ||
                    fileFormats.find(function (format) {
                        return fs.existsSync(_this.baseFilePath + '.' + format);
                    });
                ...
                if (connectionOptions) {
                    return [2, this.normalizeConnectionOptions(connectionOptions)];
                }
                return [2, undefined];
            });
        });
    ...
    ConnectionOptionsReader.prototype.normalizeConnectionOptions = function (connectionOptions) {
        ...
        connectionOptions.forEach(function (options) {
            if (options.seeds) {
                var seeds = options.seeds.map(function (seed) {
                    if (typeof seed === 'string' && seed.substr(0, 1) !== '/')
                        return _this.baseDirectory + '/' + seed;
                    return seed;
                });
